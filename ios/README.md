...
| **Profile** | Photo, name, school; past events; clubs (yours, and a page to start one); settings (your school — pick or change it, and its official calendar follows; who's going, reminders and calendar toggles, phone number verified by text, server address, Apple Intelligence, Siri); sign in / out. The same menu opens from the HostKit mark top-left on every tab |
