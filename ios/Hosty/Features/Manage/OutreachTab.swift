        ...
        List {
            if isLoading && rows.isEmpty {
                ...
                ContentUnavailableView(
                    ...
                    description: Text("Add the venue, speakers or cohosts and Hosty drafts the first message for each."))
        ...
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    Text("Only the name is required. Hosty drafts the first message from what you fill in.")
                }
