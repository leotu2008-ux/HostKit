        ...
        Form {
            ...
            Section {
                ...
                if remindersDenied && remindersOn {
                    Text("Notifications are off for Hosty in Settings.")
                        .font(.inter(.footnote))
                        .foregroundStyle(.red)
                }
                ...
                Text("The evening before and an hour before each event you register for. Calendar access is write-only — Hosty never reads your calendar.")
            }
            ...
            if model.isSignedIn {
                ...
                Section("Siri & Shortcuts") {
                    ...
                    Text("Try “Check in a guest with Hosty” at the door.")
                        .font(.inter(.footnote))
            ...
            Section {
                ...
                Text("The Hosty website this app talks to. Use a Vercel preview URL, or http://localhost:3000 while running `npm run dev` and the Simulator. Changing it signs you out.")
            }

            Section {
                Link("Open Hosty on the web", destination: model.serverURL)
