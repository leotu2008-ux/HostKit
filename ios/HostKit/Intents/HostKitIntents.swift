...
nonisolated enum IntentMessage: Error, CustomLocalizedStringResourceConvertible {
    ...
    var localizedStringResource: LocalizedStringResource {
        switch self {
        case .signIn: "Sign in to HostKit first."
...
/// "Open Rooftop Jazz Night in HostKit"
struct OpenEventIntent: OpenIntent {
    static let title: LocalizedStringResource = "Open Event"
    static let description = IntentDescription("Opens one of your events in HostKit.")
...
/// "Check in a guest with HostKit" — for the door, hands full.
struct CheckInGuestIntent: AppIntent {
    static let title: LocalizedStringResource = "Check In Guest"
    static let description = IntentDescription(
        "Checks a guest in at the door of one of your HostKit events.")
...
nonisolated struct HostKitShortcuts: AppShortcutsProvider {
