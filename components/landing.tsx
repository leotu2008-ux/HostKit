      ...
      <Rails>
        ...
        <section className="pt-16 pb-20 text-center md:pt-24 md:pb-24">
          ...
          <p
            ...
            style={stagger(2)}
          >
            <WaveText text="Brief it once and it drafts the plan, writes to the venues, chases the quotes, tracks who’s coming, and hands you a run sheet for the day. You approve. It does the rest." />
          </p>
        ...
        <Rails>
          <section className="py-16 md:py-24">
            ...
            <p className="mt-3 max-w-lg text-[16px] leading-relaxed text-ink-soft">
              <WaveText text="Not a chatbot bolted onto a form. It carries one event from the first idea to the last person through the door." />
            </p>
      ...
      <Rails>
        ...
        <Reveal as="section" className="pb-24 text-center md:pb-32">
          ...
          <p className="mx-auto mt-3 max-w-md text-[16px] leading-relaxed text-ink-soft">
            <WaveText text="You’ll have a plan before you close the tab." />
          </p>
