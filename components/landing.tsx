  ...
  return (
    <main className="relative isolate flex-1">
      ...
      <section className="mx-auto w-full max-w-4xl px-4 pt-16 pb-20 text-center md:px-8 md:pt-28 md:pb-28">
        ...
        <GlitchText
          as="h1"
          className="font-display mt-6 text-[44px] leading-[1.05] tracking-[-0.02em] text-ink md:text-[72px]"
        >
          Simplifying events.
        </GlitchText>
      ...
      <section className="mx-auto w-full max-w-6xl px-4 pb-20 md:px-8 md:pb-28">
        <ul className="grid gap-4 md:grid-cols-3">
          {FEATURES.map((feature) => (
            ...
            >
              <GlitchText as="h2" className="font-display text-[19px] leading-snug text-ink">
                {feature.title}
              </GlitchText>
      ...
      <section className="border-y border-line bg-surface">
        <div className="mx-auto w-full max-w-6xl px-4 py-16 md:px-8 md:py-20">
          <GlitchText
            as="h2"
            className="font-display block text-center text-[28px] leading-tight text-ink md:text-[36px]"
          >
          ...
          <ol className="mt-10 grid gap-8 md:grid-cols-3 md:gap-6">
            {STEPS.map((step) => (
              <li key={step.step}>
                ...
                <GlitchText as="h3" className="font-display mt-2 block text-[19px] text-ink">
                  {step.title}
                </GlitchText>
      ...
      <section className="mx-auto w-full max-w-4xl px-4 py-20 text-center md:px-8 md:py-28">
        <GlitchText
          as="h2"
          className="font-display block text-[30px] leading-tight text-ink md:text-[40px]"
        >
