# Hosty event UX — Luma-inspired design pack
...
| [RESEARCH_NOTES.md](./RESEARCH_NOTES.md) | Public help-center IA + live luma.com visual DNA, and how Hosty diverges |
| [INFORMATION_ARCHITECTURE.md](./INFORMATION_ARCHITECTURE.md) | Screens, nav (mobile-first), planner under More |
| [DESIGN_SYSTEM.md](./DESIGN_SYSTEM.md) | Hosty tokens, type, radius, components, light/dark, original theme catalog |
...
5. **Keep Hosty unique.** Venue scoring, budget write-back, run sheets, and guest-token RSVPs stay first-class. Planner screens live under the **More** tab.
