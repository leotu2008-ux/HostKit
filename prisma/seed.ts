...
const VENUES: VenueSeed[] = [
  ...
  { city: "NYC", name: "Carroll Gardens Supper Club", neighborhood: "Carroll Gardens", description: "A neighbourhood restaurant that closes for private hire. Twelve tables, one open kitchen, no corkage.", hourly: 32_000, capacityMin: 10, capacityMax: 36, leadTimeDays: 14, amenities: ["In-house catering", "No corkage", "Sound system"], tags: ["intimate", "dinner", "affordable"], rating: 4.8, reviewCount: 118 },
...
const VENDOR_SPECS: VendorSpec[] = [
  ...
  { category: "VIDEOGRAPHY", priceUnit: "FLAT", prices: [380_000, 450_000, 260_000], leadTimeDays: 45, tags: ["highlight film"], description: "%s delivers a short highlight film and the full ceremony, colour graded, no drone unless you ask.", names: ["Northlight Films", "Sunset Reel", "Lonestar Motion"] },
