...
export async function apiUser(request: Request) {
  ...
  return db.user.findUnique({
    ...
    select: { id: true, name: true, email: true, schoolDomain: true, classYear: true, bio: true, company: true, xHandle: true, linkedinHandle: true, instagramHandle: true, imageUrl: true, phone: true, phoneVerifiedAt: true },
  });
}
